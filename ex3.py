...
def display_column_data(df_train: pd.DataFrame, max_vals=10):
    ...
    '''
    # ! your code here
    columns_to_print = num_uq_vals_sr[ < your
    code
    here >].index
...
def survival_vs_family(df):
    ...
    for metric in ["SibSp", "Parch", "Family"]:
        ...
        # ! your code here
    print("To ensure the highest chance of survival, the metric ", < your
    code
    here >,
    'must have the value ', < your
    code
    here > )
